...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'verify.payment.gateway' => \App\Http\Middleware\VerifyPaymentGatewayRequest::class,
        ...
        'check.activity' => \App\Http\Middleware\CheckUserActivityStatus::class,
        'block.temp.email' => \App\Http\Middleware\BlockTemporaryEmail::class,
    ];
}
